...
import { COMMAND_PRICING, DEFAULT_PRICE } from '../billing/commandPricing.js';
...
import { recordAccepted, recordRejected, recordDuplicate } from '../observability/metrics.js';
export async function registerCommandRoutes(app) {
    app.post('/v1/commands/:commandName', async (request, reply) => {
